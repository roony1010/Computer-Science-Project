...
def draw_walls():
    left = pygame.draw.line(screen, (255, 255, 255), (0, 0), (0, h), wall_thickness)
    right = pygame.draw.line(screen, (255, 255, 255), (w, 0), (w, h), wall_thickness)
    top = pygame.draw.line(screen, (255, 255, 255), (0, 0), (w, 0), wall_thickness)
    bottom = pygame.draw.line(screen, (255, 255, 255), (0, h), (w, h), wall_thickness)
